...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.sunwenyan.OrgChart" in the application's documents directory.
...
-(void)createData
{
    ...
    NSMutableSet *johnEmployee = [john mutableSetValueForKey:@"Employees"];
    [johnEmployee addObject:jane];
    [johnEmployee addObject:bill];
...
-(void)readData{
    ...
    [fetchRequset setEntity:orgEntity];
    
    NSArray *organizations = [context executeFetchRequest:fetchRequset error:nil];
    id organization;
